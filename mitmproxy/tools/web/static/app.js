...
if (process.env.NODE_ENV !== 'production') {
    middlewares.push(_reduxLogger.logger); //Ajoute le logger dans les middleware
}

// logger must be last
var store = (0, _redux.createStore)( //Redux
_index2.default, _redux.applyMiddleware.apply(undefined, middlewares));
...
},{"./backends/static":3,"./backends/websocket":4,"./components/ProxyApp":47,"./ducks/eventLog":62,"./ducks/index":64,"./urlState":76,"_process":1,"react":"react","react-dom":"react-dom","react-redux":"react-redux","redux":"redux","redux-logger":"redux-logger","redux-thunk":"redux-thunk"}],3:[function(require,module,exports){
"use strict";
...
},{"../utils":77}],4:[function(require,module,exports){
"use strict";
...
},{"../ducks/connection":60,"../utils":77}],5:[function(require,module,exports){
'use strict';
...
},{"../ducks/ui/flow":67,"./ContentView/ContentViews":9,"./ContentView/MetaViews":11,"./ContentView/ShowFullContentButton":12,"prop-types":"prop-types","react":"react","react-redux":"react-redux"}],6:[function(require,module,exports){
'use strict';
...
},{"../../flow/utils.js":75,"prop-types":"prop-types","react":"react"}],8:[function(require,module,exports){
'use strict';
...
},{"../../ducks/ui/flow":67,"../../flow/utils":75,"./CodeEditor":6,"./ContentLoader":7,"prop-types":"prop-types","react":"react","react-redux":"react-redux"}],10:[function(require,module,exports){
'use strict';
...
},{"../../flow/utils":75,"prop-types":"prop-types","react":"react"}],11:[function(require,module,exports){
'use strict';
...
},{"../../utils.js":77,"./DownloadContentButton":10,"./UploadContentButton":13,"react":"react"}],12:[function(require,module,exports){
'use strict';
...
},{"../../ducks/ui/flow":67,"../common/Button":50,"prop-types":"prop-types","react":"react","react-dom":"react-dom","react-redux":"react-redux"}],13:[function(require,module,exports){
'use strict';
...
},{"../common/FileChooser":53,"prop-types":"prop-types","react":"react"}],14:[function(require,module,exports){
'use strict';
...
},{"../../ducks/ui/flow":67,"../common/Dropdown":52,"prop-types":"prop-types","react":"react","react-redux":"react-redux"}],15:[function(require,module,exports){
'use strict';
...
},{"../ducks/eventLog":62,"./EventLog/EventList":16,"./common/ToggleButton":57,"prop-types":"prop-types","react":"react","react-redux":"react-redux"}],16:[function(require,module,exports){
'use strict';
...
},{"../helpers/AutoScroll":58,"../helpers/VirtualScroll":59,"prop-types":"prop-types","react":"react","react-dom":"react-dom","shallowequal":"shallowequal"}],17:[function(require,module,exports){
'use strict';
...
},{"../ducks/flows":63,"../filt/filt":74,"./FlowTable/FlowRow":19,"./FlowTable/FlowTableHead":20,"./helpers/AutoScroll":58,"./helpers/VirtualScroll":59,"prop-types":"prop-types","react":"react","react-dom":"react-dom","react-redux":"react-redux","shallowequal":"shallowequal"}],18:[function(require,module,exports){
'use strict';
...
function MatchingColumn(_ref6) {
    ...
    return _react2.default.createElement(
        'td',
        { className: 'col-match' },
        matcher["Headers"].length > 0 || matcher["Content"].length > 0 || matcher["URI"].length > 0 ? "Custom" : "Default"
    );
}
...
function ResponseColumn(_ref7) {
    ...
    return _react2.default.createElement(
        'td',
        { className: 'col-resp' },
        flow.response && flow.response.reason
    );
}
...
},{"../../utils":77,"./FlowColumns":18,"classnames":"classnames","prop-types":"prop-types","react":"react"}],20:[function(require,module,exports){
'use strict';
...
},{"../../ducks/flows":63,"./FlowColumns":18,"classnames":"classnames","prop-types":"prop-types","react":"react","react-redux":"react-redux"}],21:[function(require,module,exports){
'use strict';
...
var _Matching = require('./FlowView/Matching');
...
var allTabs = exports.allTabs = { Request: _Messages.Request, Response: _Messages.Response, Error: _Messages.ErrorView, Details: _Details2.default, Matching: _Matching2.default };
...
function FlowView(_ref) {
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(Tab, { flow: flow, matcher: matcher })
    );
}
...
},{"../ducks/ui/flow":67,"./FlowView/Details":22,"./FlowView/Matching":24,"./FlowView/Messages":25,"./FlowView/Nav":26,"lodash":"lodash","react":"react","react-redux":"react-redux"}],22:[function(require,module,exports){
'use strict';
...
},{"../../utils.js":77,"lodash":"lodash","react":"react"}],23:[function(require,module,exports){
'use strict';
...
},{"../../utils":77,"../ValueEditor/ValueEditor":49,"prop-types":"prop-types","react":"react","react-dom":"react-dom"}],24:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.MatchingView = MatchingView;
...
var _RuleInput = require('./RuleInput');

var _RuleInput2 = _interopRequireDefault(_RuleInput);
...
var UIActions = _interopRequireWildcard(_flow);
...
var _RuleTable = require('./RuleTable');

var _RuleTable2 = _interopRequireDefault(_RuleTable);
...
var HeaderInput = (0, _reactRedux.connect)(function (state) {
  return {
    value: state.ui.flow.modifyRule["Header"],
    placeholder: 'Header'
  };
}, { onChange: UIActions.setHeader })(_Input2.default);

var ValueInput = (0, _reactRedux.connect)(function (state) {
  return {
    value: state.ui.flow.modifyRule["Value"],
    placeholder: 'Value',
    condition: state.ui.flow.modifyRule["Condition"].charAt(0)
  };
}, { onChange: UIActions.setValue })(_RuleInput2.default);

function MatchingView(_ref) {
  var flow = _ref.flow,
      matcher = _ref.matcher,
      isEdit = _ref.isEdit,
      ...
      selectedContent = _ref.selectedContent,
      selectedURI = _ref.selectedURI,
      cancelModifyRule = _ref.cancelModifyRule,
      selectRule = _ref.selectRule,
      modifyingRule = _ref.modifyingRule,
      header = _ref.header,
      condition = _ref.condition,
      currentCond = _ref.currentCond,
      setCondition = _ref.setCondition,
      value = _ref.value,
      validateRule = _ref.validateRule,
      dispatchRule = _ref.dispatchRule;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'article',
      null,
      !modifyingRule && _react2.default.createElement(_ToggleEdit2.default, null),
      _react2.default.createElement(_RuleTable2.default, {
        isEdit: isEdit,
        flow: flow,
        matcher: matcher,
      ...
      modifyingRule && _react2.default.createElement(
        _reactModal2.default,
        {
          isOpen: modifyingRule,
          style: customStyles,
          contentLabel: 'Choisissez le nom du sc\xE9nario' },
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                modifyingRule["Label"] === "Headers" && _react2.default.createElement(
                  'div',
                  null,
                  _react2.default.createElement(
                    'h4',
                  ...
                  _react2.default.createElement(HeaderInput, null),
                ...
                _react2.default.createElement(
                  'label',
                  { className: 'switch' },
                  _react2.default.createElement('input', { type: 'checkbox', checked: condition.charAt(1) == 'n', onChange: function onChange() {
                      return setCondition('n');
                    }, value: 'Not' }),
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement('input', { type: 'radio', value: '', checked: condition.charAt(0) == 'c', onChange: function onChange() {
                ...
                _react2.default.createElement(
                  'label',
                  { className: 'radio-inline' },
                  _react2.default.createElement('input', { type: 'radio', value: '', checked: condition.charAt(0) == 'e', onChange: function onChange() {
                      return setCondition('e');
                    } }),
                  'equals'
                ),
                _react2.default.createElement(
                  'label',
                  { className: 'radio-inline' },
                  _react2.default.createElement('input', { type: 'radio', value: '', checked: condition.charAt(0) == 'm', onChange: function onChange() {
                      return setCondition('m');
                    } }),
                  'match'
                ),
                _react2.default.createElement(
                  'label',
                  { className: 'radio-inline' },
                  _react2.default.createElement('input', { type: 'radio', value: '', checked: condition.charAt(0) == 'x', onChange: function onChange() {
                      return setCondition('x');
                    } }),
                  'match XPath/JSONPath'
                ),
                _react2.default.createElement('br', null),
                ' ',
                _react2.default.createElement('br', null),
                ...
                _react2.default.createElement('hr', null),
                _react2.default.createElement(ValueInput, null),
                _react2.default.createElement('br', null),
                ' ',
                _react2.default.createElement('br', null)
              )
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _Button2.default,
              { title: 'Valider', disabled: modifyingRule["Label"] === "Headers" && header === "" || value === "", onClick: function onClick() {
                  dispatchRule(flow.id, modifyingRule);validateRule(flow.id, modifyingRule);
                } },
              'VALIDER'
            ),
            _react2.default.createElement(
              _Button2.default,
              { title: 'Annuler', onClick: function onClick() {
                  return cancelModifyRule();
                } },
              'ANNULER'
            )
          )
...
},{"../../ducks/flows":63,"../../ducks/ui/flow":67,"../../flow/utils.js":75,"../../utils.js":77,"../ContentView":5,"../ContentView/ContentViewOptions":8,"../ValueEditor/ValidateEditor":48,"../ValueEditor/ValueEditor":49,"../common/Button":50,"../common/HideInStatic":54,"../common/Input":55,"./Headers":23,"./RuleInput":27,"./RuleTable":28,"./ToggleEdit":29,"prop-types":"prop-types","react":"react","react-input-range":"react-input-range","react-modal":"react-modal","react-redux":"react-redux"}],25:[function(require,module,exports){
'use strict';
...
},{"classnames":"classnames","lodash":"lodash","prop-types":"prop-types","react":"react","react-redux":"react-redux"}],27:[function(require,module,exports){
'use strict';
...
var RuleInput = function (_Component) {
    _inherits(RuleInput, _Component);

    function RuleInput(props, context) {
        _classCallCheck(this, RuleInput);

        // Consider both focus and mouseover for showing/hiding the tooltip,
        // because onBlur of the input is triggered before the click on the tooltip
        // finalized, hiding the tooltip just as the user clicks on it.
        var _this = _possibleConstructorReturn(this, (RuleInput.__proto__ || Object.getPrototypeOf(RuleInput)).call(this, props, context));

        _this.state = { value: _this.props.value, condition: _this.props.condition, focus: false, mousefocus: false };
    ...
    _createClass(RuleInput, [{
            ...
            try {
                ...
                if (str) {
                    switch (this.state.condition) {
                        ...
                        case 'x':
                            console.log("XPATH");
                            console.log(_xpath2.default.select(str, ""));
        ...
        value: function getDesc() {
            if (!this.state.value) {
                return _react2.default.createElement(FilterDocs, { selectHandler: this.selectFilter });
            }
            try {
...
exports.default = RuleInput;

},{"../../filt/filt":74,"../../utils.js":77,"classnames":"classnames","jsonpath":"jsonpath","prop-types":"prop-types","react":"react","react-dom":"react-dom","xpath":"xpath"}],28:[function(require,module,exports){
'use strict';
...
RuleTable.propTypes = {
  ...
  deleteRule: _propTypes2.default.func.isRequired,
  upRule: _propTypes2.default.func.isRequired,
  downRule: _propTypes2.default.func.isRequired,
  editRule: _propTypes2.default.func.isRequired,
  matcher: _propTypes2.default.object.isRequired
};

function RuleTable(_ref) {
  var flow = _ref.flow,
      matcher = _ref.matcher,
      label = _ref.label,
      isEdit = _ref.isEdit,
      selectRule = _ref.selectRule,
      selectedMatcher = _ref.selectedMatcher,
      addRule = _ref.addRule,
      deleteRule = _ref.deleteRule,
      upRule = _ref.upRule,
      downRule = _ref.downRule,
      editRule = _ref.editRule,
      modifyRule = _ref.modifyRule,
      deleteRuleDis = _ref.deleteRuleDis,
      upRuleDis = _ref.upRuleDis,
      downRuleDis = _ref.downRuleDis;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      isEdit && _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { type: 'button', onClick: function onClick() {
              return addRule(label);
            }, className: 'btn btn-primary btn-block' },
          'Add'
        ),
        _react2.default.createElement(
          'button',
          { type: 'button', disabled: selectedMatcher === false, onClick: function onClick() {
              return editRule(label, selectedMatcher, matcher);
            }, className: 'btn btn-primary btn-block' },
          'Edit'
        ),
        _react2.default.createElement(
          'button',
          { type: 'button', disabled: selectedMatcher === false, onClick: function onClick() {
              deleteRuleDis(flow.id, label, selectedMatcher);deleteRule(label, selectedMatcher, flow.id, matcher[label].length);
            }, className: 'btn btn-primary btn-block' },
          'Delete'
        ),
        _react2.default.createElement(
          'button',
          { type: 'button', disabled: selectedMatcher === false, onClick: function onClick() {
              upRuleDis(flow.id, label, selectedMatcher);upRule(label, selectedMatcher, flow.id, matcher[label].length);
            }, className: 'btn btn-primary btn-block' },
          'Up'
        ),
        _react2.default.createElement(
          'button',
          { type: 'button', disabled: selectedMatcher === false, onClick: function onClick() {
              downRuleDis(flow.id, label, selectedMatcher);downRule(label, selectedMatcher, flow.id, matcher[label].length);
            }, className: 'btn btn-primary btn-block' },
          'Down'
        )
      ),
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'table-responsive rule-table', style: { width: '100%', height: '100%', border: "1px solid black" } },
          _react2.default.createElement(
            'table',
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'tr',
                null,
                label == "Headers" && _react2.default.createElement(
                  'th',
                  null,
                  'Header'
                ),
            ...
            _react2.default.createElement(
              ...
              matcher[label].map(function (rule, index) {
                return _react2.default.createElement(
                  'tr',
                  { className: index === selectedMatcher ? "selected" : "", onClick: function onClick() {
                      if (isEdit) selectRule(label, index);
                    }, key: index },
                  label == "Headers" && _react2.default.createElement(
                    'td',
                    null,
    ...
    _react2.default.createElement('br', null),
    _react2.default.createElement('hr', { style: { height: "1px", border: "none", color: "#333" } })
  );
}
...
},{"../../ducks/flows":63,"../../ducks/ui/flow":67,"prop-types":"prop-types","react":"react","react-dom":"react-dom","react-redux":"react-redux","shallowequal":"shallowequal"}],29:[function(require,module,exports){
'use strict';
...
},{"../../ducks/ui/flow":67,"prop-types":"prop-types","react":"react","react-redux":"react-redux"}],30:[function(require,module,exports){
'use strict';
...
},{"../components/common/HideInStatic":54,"../utils.js":77,"prop-types":"prop-types","react":"react","react-redux":"react-redux"}],31:[function(require,module,exports){
'use strict';
...
var _EditMenu = require('./Header/EditMenu');
...
Header.entries = [_EditMenu2.default, _OptionMenu2.default];
exports.default = (0, _reactRedux.connect)(function (state) {
    return {
...
},{"../ducks/ui/header":68,"./Header/ConnectionIndicator":32,"./Header/EditMenu":33,"./Header/FileMenu":34,"./Header/FlowMenu":37,"./Header/MainMenu":38,"./Header/OptionMenu":40,"./common/HideInStatic":54,"classnames":"classnames","prop-types":"prop-types","react":"react","react-redux":"react-redux"}],32:[function(require,module,exports){
"use strict";
...
},{"../../ducks/connection":60,"prop-types":"prop-types","react":"react","react-redux":"react-redux"}],33:[function(require,module,exports){
"use strict";
...
var _edit = require("../../ducks/edit");

var editActions = _interopRequireWildcard(_edit);
...
EditMenu.propTypes = {
  learning: _propTypes2.default.bool.isRequired,
  renaming: _propTypes2.default.bool.isRequired,
  showModal: _propTypes2.default.bool.isRequired,
  scenarios: _propTypes2.default.array.isRequired,
  scenario: _propTypes2.default.string.isRequired,
  tmpScen: _propTypes2.default.string.isRequired,
  bouchon: _propTypes2.default.bool.isRequired,
...
function EditMenu(_ref) {
  var openEdit = _ref.openEdit,
      learningAction = _ref.learningAction,
      learning = _ref.learning,
      switchLearning = _ref.switchLearning,
      ...
      selectTab = _ref.selectTab,
      changeScenPY = _ref.changeScenPY,
      tmpScen = _ref.tmpScen,
      validateScen = _ref.validateScen,
      deleteTab = _ref.deleteTab,
      removeScenPY = _ref.removeScenPY,
      dumpScen = _ref.dumpScen,
      loadFlows = _ref.loadFlows,
      renameAction = _ref.renameAction,
      renaming = _ref.renaming,
      copyTab = _ref.copyTab,
      copyScenPY = _ref.copyScenPY,
      bouchon = _ref.bouchon,
      switchBouchonMode = _ref.switchBouchonMode,
      switchBouchonModePY = _ref.switchBouchonModePY,
      flow = _ref.flow,
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _HideInStatic2.default,
      null,
      !bouchon && _react2.default.createElement(
        "div",
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Button2.default,
            { title: learning ? "Stop" : "Start", icon: learning ? "fa-times text-primary" : "fa-play text-primary",
              onClick: function onClick() {
                learningAction();switchLearning();
              } },
            learning ? "Arrêter" : "Commencer"
          ),
          !learning && scenario != "" && _react2.default.createElement(
            _Button2.default,
            { title: "Sauvegarder", icon: "fa-download", onClick: function onClick() {
                return dumpScen();
              } },
            "Sauvegarder"
          ),
          !learning && scenario != "" && _react2.default.createElement(
            _Button2.default,
            { title: "Supprimer sc\xE9nario", icon: "fa-trash", onClick: function onClick() {
                ;deleteTab(scenario);removeScenPY(scenario);
              } },
            "Supprimer"
          ),
          !learning && scenario != "" && _react2.default.createElement(
            _Button2.default,
            { title: "Renommer sc\xE9nario", icon: "fa-pencil", onClick: function onClick() {
                return renameAction();
              } },
            "Renommer"
          ),
          !learning && _react2.default.createElement(_FileChooser2.default, {
            icon: "fa-folder-open",
            text: "\xA0Open...",
            onOpenFile: function onOpenFile(file) {
              file.name.endsWith(".fl") && selectTab(file.name.slice(0, file.name.indexOf(".fl")));
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                "div",
                { className: "react-modal-body" },
                _react2.default.createElement(ScenInput, null)
              ),
              _react2.default.createElement(
                "div",
                { className: "react-modal-footer" },
                _react2.default.createElement(
                  _Button2.default,
                  { title: "Valider", disabled: tmpScen == "" || scenarios.indexOf(tmpScen) > -1, onClick: function onClick() {
                      if (showModal) {
      ...
      flow && scenario != "" && !learning && !bouchon && _react2.default.createElement(
        "div",
        { className: "menu-group" },
        _react2.default.createElement(
          "div",
          ...
          _react2.default.createElement(
            _Button2.default,
            { title: "[D]uplicate flow", icon: "fa-copy text-info", readonly: true,
              onClick: function onClick() {
          ...
          _react2.default.createElement(
            _Button2.default,
            { title: "[d]elete flow", icon: "fa-trash text-danger", readonly: true,
              onClick: function onClick() {
      ...
      !learning && scenario != "" && _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            _Button2.default,
            { title: "Bouchonner", icon: bouchon ? "fa-stop" : "fa-forward", onClick: function onClick() {
                switchBouchonMode();switchBouchonModePY();
              } },
            bouchon ? "Stop" : "Bouchonner"
          )
        ),
        _react2.default.createElement(
          "div",
...
var ScenInput = (0, _reactRedux.connect)(function (state) {
  return {
    tmpScen: state.edit.tmpScen || ''
  };
}, { onChange: editActions.handleChange })(_Input2.default);
...
exports.default = (0, _reactRedux.connect)(function (state) {
  ...
  openEdit: function openEdit() {
    return modalActions.setActiveModal('EditModal');
  },
...
},{"../../ducks/edit":61,"../../ducks/flows":63,"../../ducks/ui/modal":71,"../common/Button":50,"../common/DocsLink":51,"../common/FileChooser":53,"../common/HideInStatic":54,"../common/Input":55,"prop-types":"prop-types","react":"react","react-modal":"react-modal","react-redux":"react-redux"}],34:[function(require,module,exports){
'use strict';
...
exports.default = (0, _reactRedux.connect)(null, {
    ...
    selectTab: flowsActions.selectTab,
    changeScenPY: flowsActions.changeScenario,
    switchScen: editActions.switchScen
})(FileMenu);

},{"../../ducks/edit":61,"../../ducks/flows":63,"../../ducks/ui/modal":71,"../common/Dropdown":52,"../common/FileChooser":53,"../common/HideInStatic":54,"prop-types":"prop-types","react":"react","react-redux":"react-redux"}],35:[function(require,module,exports){
'use strict';
...
},{"../../utils":77,"react":"react"}],36:[function(require,module,exports){
'use strict';
...
},{"../../filt/filt":74,"../../utils.js":77,"./FilterDocs":35,"classnames":"classnames","prop-types":"prop-types","react":"react","react-dom":"react-dom"}],37:[function(require,module,exports){
"use strict";
...
},{"../../ducks/flows":63,"../../flow/utils.js":75,"../common/Button":50,"../common/HideInStatic":54,"prop-types":"prop-types","react":"react","react-redux":"react-redux"}],38:[function(require,module,exports){
"use strict";
...
},{"../../ducks/flows":63,"../../ducks/settings":66,"./FilterInput":36,"prop-types":"prop-types","react":"react","react-redux":"react-redux"}],39:[function(require,module,exports){
"use strict";
...
},{"../../ducks/eventLog":62,"../../ducks/settings":66,"prop-types":"prop-types","react-redux":"react-redux"}],40:[function(require,module,exports){
"use strict";
...
},{"../../ducks/ui/modal":71,"../common/Button":50,"../common/DocsLink":51,"../common/HideInStatic":54,"./MenuToggle":39,"react":"react","react-redux":"react-redux"}],41:[function(require,module,exports){
'use strict';
...
function MainView(_ref) {
    ...
    return _react2.default.createElement(
        'div',
        { id: 'container' },
        scenarios.length > 0 && _react2.default.createElement(_Nav2.default, {
            tabs: scenarios,
            active: scenario,
            onSelectTab: function onSelectTab(scenario) {
                !learning && selectTab(scenario);!learning && changeScen(scenario);
            }
        }),
        _react2.default.createElement(
            'div',
            ...
            hasSelection && !learning && !bouchon && _react2.default.createElement(_Splitter2.default, { key: 'splitter' }),
            hasSelection && !learning && !bouchon && _react2.default.createElement(_FlowView2.default, { key: 'flowDetails' })
        )
    );
}
...
exports.default = (0, _reactRedux.connect)(function (state) {
    ...
    changeScen: flowsActions.changeScenario })(MainView);

},{"../ducks/edit":61,"../ducks/flows":63,"./FlowTable":17,"./FlowView":21,"./FlowView/Nav":26,"./common/Splitter":56,"prop-types":"prop-types","react":"react","react-redux":"react-redux"}],42:[function(require,module,exports){
'use strict';
...
},{"./ModalList":44,"react":"react","react-redux":"react-redux"}],43:[function(require,module,exports){
"use strict";
...
},{"./ModalLayout":43,"./OptionModal":46,"react":"react"}],45:[function(require,module,exports){
"use strict";
...
},{"../../ducks/options":65,"../../utils":77,"classnames":"classnames","prop-types":"prop-types","react":"react","react-redux":"react-redux"}],46:[function(require,module,exports){
"use strict";
...
},{"../../ducks/options":65,"../../ducks/ui/modal":71,"./Option":45,"lodash":"lodash","react":"react","react-redux":"react-redux"}],47:[function(require,module,exports){
'use strict';
...
},{"../ducks/ui/keyboard":70,"./EventLog":15,"./Footer":30,"./Header":31,"./MainView":41,"./Modal/Modal":42,"prop-types":"prop-types","react":"react","react-redux":"react-redux"}],48:[function(require,module,exports){
'use strict';
...
},{"./ValueEditor":49,"classnames":"classnames","prop-types":"prop-types","react":"react"}],49:[function(require,module,exports){
'use strict';
...
},{"../../utils":77,"classnames":"classnames","lodash":"lodash","prop-types":"prop-types","react":"react"}],50:[function(require,module,exports){
"use strict";
...
},{"classnames":"classnames","prop-types":"prop-types","react":"react"}],51:[function(require,module,exports){
"use strict";
...
},{"prop-types":"prop-types","react":"react"}],52:[function(require,module,exports){
'use strict';
...
},{"classnames":"classnames","prop-types":"prop-types","react":"react"}],53:[function(require,module,exports){
'use strict';
...
},{"classnames":"classnames","prop-types":"prop-types","react":"react"}],54:[function(require,module,exports){
(function (global){
'use strict';
...
var Input = function (_Component) {
    ...
    function Input(props, context) {
        ...
        _this.state = { value: _this.props.value, scenario: _this.props.value };
...
},{"classnames":"classnames","prop-types":"prop-types","react":"react","react-dom":"react-dom"}],56:[function(require,module,exports){
'use strict';
...
},{"classnames":"classnames","react":"react","react-dom":"react-dom"}],57:[function(require,module,exports){
'use strict';
...
},{"prop-types":"prop-types","react":"react"}],58:[function(require,module,exports){
"use strict";
...
},{"react":"react","react-dom":"react-dom"}],59:[function(require,module,exports){
"use strict";
...
exports.SWITCH_BOUCHON = exports.RENAME_ACTION = exports.REMOVE_SCEN = exports.VALIDATE_SCEN = exports.SWITCH_SCEN = exports.MODAL_CLOSED = exports.HANDLE_CHANGE = exports.LEARNING_ACTION = undefined;

var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };

exports.default = reduce;
exports.learningAction = learningAction;
exports.renameAction = renameAction;
exports.modalClosed = modalClosed;
exports.validateScen = validateScen;
exports.handleChange = handleChange;
exports.switchScen = switchScen;
exports.removeScen = removeScen;
exports.switchBouchonMode = switchBouchonMode;
...
var LEARNING_ACTION = exports.LEARNING_ACTION = 'LEARNING_ACTION';
var HANDLE_CHANGE = exports.HANDLE_CHANGE = 'HANDLE_CHANGE';
var MODAL_CLOSED = exports.MODAL_CLOSED = 'MODAL_CLOSED';
var SWITCH_SCEN = exports.SWITCH_SCEN = 'SWITCH_SCEN';
var VALIDATE_SCEN = exports.VALIDATE_SCEN = 'VALIDATE_SCEN';
var REMOVE_SCEN = exports.REMOVE_SCEN = 'REMOVE_SCEN';
var RENAME_ACTION = exports.RENAME_ACTION = 'RENAME_ACTION';
var SWITCH_BOUCHON = exports.SWITCH_BOUCHON = 'SWITCH_BOUCHON';

var defaultState = { learning: false,
  tmpScen: "",
  showModal: false,
  renaming: false,
  bouchon: false };
...
function learningAction() {
  _reactModal2.default.setAppElement('#mitmproxy');
...
function validateScen(scen) {
  return { type: VALIDATE_SCEN,
    learning: true,
    scenario: scen };
}
function handleChange(scen) {
...
function switchBouchonMode() {
  return { type: SWITCH_BOUCHON };
}

},{"./flows":63,"react-modal":"react-modal"}],62:[function(require,module,exports){
"use strict";
...
},{"./utils/store":73}],63:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.SWITCH_BOUCHON = exports.LEARNING_ACTION = exports.RULE_DELETE = exports.RULE_DOWN = exports.RULE_UP = exports.RULE_UPDATE = exports.MATCHER_UPDATE = exports.HIGHLIGHT = exports.COPY = exports.DELETE = exports.CHANGE = exports.REQUEST_ACTION = exports.SET_HIGHLIGHT = exports.SET_SORT = exports.SET_FILTER = exports.SELECT = exports.RECEIVE = exports.REMOVE = exports.UPDATE = exports.ADD = undefined;
...
exports.switchLearning = switchLearning;
exports.changeScenario = changeScenario;
exports.removeScen = removeScen;
exports.copyScen = copyScen;
exports.dispatchRule = dispatchRule;
exports.deleteRuleDis = deleteRuleDis;
exports.upRuleDis = upRuleDis;
exports.downRuleDis = downRuleDis;
exports.switchBouchonMode = switchBouchonMode;
...
exports.copyTab = copyTab;
exports.updateRule = updateRule;
exports.upRule = upRule;
exports.downRule = downRule;
...
var CHANGE = exports.CHANGE = 'FLOWS_CHANGE_SCEN';
var DELETE = exports.DELETE = 'FLOWS_DELETE_SCEN';
var COPY = exports.COPY = 'FLOWS_COPY_SCEN';
var HIGHLIGHT = exports.HIGHLIGHT = 'FLOWS_HIGHLIGHT';
var MATCHER_UPDATE = exports.MATCHER_UPDATE = 'MATCHER_UPDATER';
var RULE_UPDATE = exports.RULE_UPDATE = 'RULE_UPDATE';
var RULE_UP = exports.RULE_UP = 'RULE_UP';
var RULE_DOWN = exports.RULE_DOWN = 'RULE_DOWN';
var RULE_DELETE = exports.RULE_DELETE = 'RULE_DELETE';
var LEARNING_ACTION = exports.LEARNING_ACTION = 'LEARNING_ACTION';
var SWITCH_BOUCHON = exports.SWITCH_BOUCHON = 'SWITCH_BOUCHON';
...
function reduce() {
    ...
    switch (action.type) {
        ...
        case MATCHER_UPDATE:
            var storedAction = storeActions[action.cmd](action.data, makeFilter(state.filter), makeSort(state.sort));
            return _extends({}, state, (0, storeActions.default)(state, storedAction));
        case HIGHLIGHT:
            return _extends({}, state, {
                highlight: action.data
            });
        case RULE_UPDATE:
            return _extends({}, state, (0, storeActions.default)(state, storeActions.updateRule(action.id, action.rule)));

        case RULE_UP:
            return _extends({}, state, (0, storeActions.default)(state, storeActions.upRule(action.label, action.index, action.id)));
        case RULE_DOWN:
            return _extends({}, state, (0, storeActions.default)(state, storeActions.downRule(action.label, action.index, action.id)));
        case RULE_DELETE:
            return _extends({}, state, (0, storeActions.default)(state, storeActions.deleteRule(action.label, action.index, action.id)));
        ...
        case CHANGE:
            return _extends({}, state, (0, storeActions.default)(state, storeActions.change(action.scenario)));

        case DELETE:
            return _extends({}, state, (0, storeActions.default)(state, storeActions.deleteScen(action.scenario)));
        case COPY:
            return _extends({}, state, (0, storeActions.default)(state, storeActions.copyScen(action.scenario)));
        case SWITCH_BOUCHON:
            return _extends({}, state, {
                highlight: null
            });
...
function switchLearning() {
    return function (dispatch) {
        return (0, _utils.fetchApi)("/learn", { method: 'POST' });
    };
}

function changeScenario(scenario) {
    return function (dispatch) {
        return (0, _utils.fetchApi)("/scenario/" + scenario, { method: 'POST' });
    };
}

function removeScen(scenario) {
    return function (dispatch) {
        return (0, _utils.fetchApi)("/scenario/" + scenario + "/remove", { method: 'POST' });
    };
}

function copyScen(scenario) {
    return function (dispatch) {
        return (0, _utils.fetchApi)("/scenario/" + scenario + "/copy", { method: 'POST' });
    };
}

function dispatchRule(flowId, rule) {
    return function (dispatch) {
        return _utils.fetchApi.put("/flows/" + flowId + "/rule/update", rule);
    };
}

function deleteRuleDis(flowId, label, index) {
    return function (dispatch) {
        return (0, _utils.fetchApi)("/flows/" + flowId + "/rule/" + label + "/" + index + "/delete", { method: 'POST' });
    };
}

function upRuleDis(flowId, label, index) {
    return function (dispatch) {
        return (0, _utils.fetchApi)("/flows/" + flowId + "/rule/" + label + "/" + index + "/up", { method: 'POST' });
    };
}

function downRuleDis(flowId, label, index) {
    return function (dispatch) {
        return (0, _utils.fetchApi)("/flows/" + flowId + "/rule/" + label + "/" + index + "/down", { method: 'POST' });
    };
}

function switchBouchonMode() {
    return function (dispatch) {
        return (0, _utils.fetchApi)("bouchon", { method: 'POST' });
    };
}
...
function updateRule(id, rule) {
    return { type: RULE_UPDATE, id: id, rule: rule };
}

function upRule(label, index, id, rulesLength) {
    return { type: RULE_UP, label: label, index: index, id: id, rulesLength: rulesLength };
}

function downRule(label, index, id, rulesLength) {
    return { type: RULE_DOWN, label: label, index: index, id: id, rulesLength: rulesLength };
}

function deleteRule(label, index, id, rulesLength) {
...
},{"./connection":60,"./edit":61,"./eventLog":62,"./flows":63,"./options":65,"./settings":66,"./ui/index":69,"redux":"redux"}],65:[function(require,module,exports){
"use strict";
...
},{"../utils":77,"./ui/optionsEditor":72,"lodash":"lodash"}],66:[function(require,module,exports){
'use strict';
...
exports.VALIDATE_RULE = exports.SET_VALUE = exports.SET_CONDITION = exports.SET_HEADER = exports.CANCEL_MODIFY = exports.DOWN_RULE = exports.UP_RULE = exports.EDIT_RULE = exports.DELETE_RULE = exports.ADD_RULE = exports.SELECT_RULE = exports.SET_CONTENT = exports.SET_CONTENT_VIEW_DESCRIPTION = exports.SET_SHOW_FULL_CONTENT = exports.UPLOAD_CONTENT = exports.UPDATE_EDIT = exports.START_EDIT = exports.SET_TAB = exports.DISPLAY_LARGE = exports.SET_CONTENT_VIEW = undefined;
...
exports.cancelModify = cancelModify;
...
var SET_CONTENT_VIEW = exports.SET_CONTENT_VIEW = 'UI_FLOWVIEW_SET_CONTENT_VIEW',
    ...
    SELECT_RULE = exports.SELECT_RULE = "UI_SELECT_RULE",
    ADD_RULE = exports.ADD_RULE = "UI_ADD_RULE",
    DELETE_RULE = exports.DELETE_RULE = "UI_DELETE_RULE",
    EDIT_RULE = exports.EDIT_RULE = "UI_EDIT_RULE",
    UP_RULE = exports.UP_RULE = "UI_UP_RULE",
    DOWN_RULE = exports.DOWN_RULE = "UI_DOWN_RULE",
    CANCEL_MODIFY = exports.CANCEL_MODIFY = "UI_CANCEL_MODIFY",
    SET_HEADER = exports.SET_HEADER = "UI_SET_HEADER",
    SET_CONDITION = exports.SET_CONDITION = "UI_SET_CONDITION",
    SET_VALUE = exports.SET_VALUE = "UI_SET_VALUE",
    VALIDATE_RULE = exports.VALIDATE_RULE = "UI_VALIDATE_RULE";
...
function reducer() {
  ...
  switch (action.type) {
    ...
    case SELECT_RULE:
      var tmpSelectedMatcher = state.selectedMatcher;
...
function selectRule(rules, index) {
  return { type: SELECT_RULE, rules: rules, index: index };
}

function addRule(rules) {

  return { type: ADD_RULE, rules: rules };
}

function deleteRule(rules, index, flowId, rulesLength) {
  return flowsActions.deleteRule(rules, index, flowId, rulesLength);
}

function upRule(rules, index, flowId, rulesLength) {
  return flowsActions.upRule(rules, index, flowId, rulesLength);
}

function downRule(rules, index, flowId, rulesLength) {
  return flowsActions.downRule(rules, index, flowId, rulesLength);
}

function editRule(rules, index, matcher) {
  return { type: EDIT_RULE, rules: rules, index: index, matcher: matcher };
}
...
function setHeader(header) {
  return { type: SET_HEADER, header: header };
}

function setCondition(condition) {
  return { type: SET_CONDITION, condition: condition };
}
...
},{"../../utils":77,"../flows":63,"lodash":"lodash","react-modal":"react-modal"}],68:[function(require,module,exports){
'use strict';
...
},{"../flows":63}],69:[function(require,module,exports){
'use strict';
...
},{"./flow":67,"./header":68,"./modal":71,"./optionsEditor":72,"redux":"redux"}],70:[function(require,module,exports){
"use strict";
...
function onKeyDown(e) {
    ...
    return function (dispatch, getState) {
        ...
        console.log(getState().edit.tmpScen);
        var flows = getState().flows,
            flow = flows.byId[getState().flows.selected[0]];

        if (getState().edit.showModal) {
            switch (key) {
                case _utils.Key.ENTER:
                    var scen = getState().edit.tmpScen;
                    if (scen != "") {
                        dispatch(editActions.validateScen(scen));
                        dispatch(editActions.modalClosed());
                        dispatch(flowsActions.selectTab(scen));
                        dispatch(flowsActions.changeScenario(scen));
                    }
                    break;
                case _utils.Key.ESC:
                    dispatch(editActions.modalClosed());
        ...
        } else if (getState().edit.renaming) {
            switch (key) {
                case _utils.Key.ENTER:
                    var _scen = getState().edit.tmpScen;
                    dispatch(flowsActions.copyTab(_scen));
                    dispatch(editActions.modalClosed());
                    dispatch(flowsActions.copyScen(_scen));
                    break;
                case _utils.Key.ESC:
                    dispatch(editActions.modalClosed());
                    break;
...
},{"../../utils":77,"../edit":61,"../flows":63,"./flow":67,"./modal":71}],71:[function(require,module,exports){
'use strict';
...
},{"./modal":71}],73:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.RULE_DELETE = exports.RULE_DOWN = exports.RULE_UP = exports.RULE_UPDATE = exports.COPY = exports.DELETE = exports.CHANGE = exports.RECEIVE = exports.REMOVE = exports.MATCHER_UPDATE = exports.UPDATE = exports.ADD = exports.SET_SORT = exports.SET_FILTER = undefined;
...
var MATCHER_UPDATE = exports.MATCHER_UPDATE = 'MATCHER_UPDATE';
var REMOVE = exports.REMOVE = 'LIST_REMOVE';
var RECEIVE = exports.RECEIVE = 'LIST_RECEIVE';
var CHANGE = exports.CHANGE = 'CHANGE_SCEN';
var DELETE = exports.DELETE = 'DELETE_SCEN';
var COPY = exports.COPY = 'COPY_SCEN';
var RULE_UPDATE = exports.RULE_UPDATE = 'RULE_UPDATE';
var RULE_UP = exports.RULE_UP = 'RULE_UP';
var RULE_DOWN = exports.RULE_DOWN = 'RULE_DOWN';
var RULE_DELETE = exports.RULE_DELETE = 'RULE_DELETE';
...
var defaultState = {
    ...
    if (scenario != "" || action.type == CHANGE || action.type == RECEIVE) {
        switch (action.type) {
            ...
            case ADD:
                ...
                RuleById = _extends({}, RuleById, _defineProperty({}, action.item.id, {
                    "Headers": [],
                    "Content": [],
                    "URI": []
                }));
            ...
            case MATCHER_UPDATE:
                for (var key in action.item) {
                    RuleById = _extends({}, RuleById, _defineProperty({}, key, action.item[key]));
                }
                break;

            case RULE_UPDATE:
                console.log(action.rule);
                var label = action.rule["Label"];
                delete action.rule["Label"];
                var RuleIndex = action.rule["Index"];
            ...
            case RULE_UP:
                if (action.index > 0) {
                    var tmpRule = RuleById[action.id][action.label][action.index];
            ...
            case RULE_DOWN:
                if (action.index < RuleById[action.id][action.label].length - 1) {
                    var _tmpRule = RuleById[action.id][action.label][action.index];
                    RuleById[action.id][action.label][action.index] = RuleById[action.id][action.label][action.index + 1];
                    RuleById[action.id][action.label][action.index + 1] = _tmpRule;
                }
                break;
            ...
            case RECEIVE:
                if (typeof action.list[action.list.length - 1] === "string") scenario = action.list.pop();
                list = [];
                listIndex = {};
                byId = {};
                RuleById = {};
                view = [];
                viewIndex = {};
                action.list.forEach(function (item, i) {
                    if (item instanceof Array) {
                        if (typeof item[0].scenario != "undefined" && !(item[0].scenario in scenarios)) scenarios[item[0].scenario] = {
                            byId: {},
                            RuleById: {},
                            list: [],
                            listIndex: {},
            ...
            case CHANGE:
                ...
                if (!(action.scenario in scenarios)) scenarios[action.scenario] = {
                    byId: {},
                    RuleById: {},
                    list: [],
                    listIndex: {},
            ...
            case DELETE:
                ...
                var index = keys.indexOf(action.scenario);
                if (keys.length == 1) {
                    scenario = "";
                    byId = {};
                    RuleById: {}
    ...
    return { byId: byId, RuleById: RuleById, list: list, listIndex: listIndex, view: view, viewIndex: viewIndex, scenario: scenario, scenarios: scenarios };
}
...
function updater(item) {
    ...
    return { type: MATCHER_UPDATE, item: item, filter: filter, sort: sort };
}
...
function change(scenario) {
    return { type: CHANGE, scenario: scenario };
}

function deleteScen(scenario) {
    return { type: DELETE, scenario: scenario };
}

function copyScen(scenario) {
    return { type: COPY, scenario: scenario };
}
...
function upRule(label, index, id) {
    return { type: RULE_UP, id: id, label: label, index: index };
}

function downRule(label, index, id) {
    return { type: RULE_DOWN, id: id, label: label, index: index };
}

function deleteRule(label, index, id) {
    return { type: RULE_DELETE, id: id, label: label, index: index };
}
...
},{"stable":"stable"}],74:[function(require,module,exports){
"use strict";
...
},{"../flow/utils.js":75}],75:[function(require,module,exports){
"use strict";
...
},{"lodash":"lodash"}],76:[function(require,module,exports){
"use strict";
...
},{"./ducks/eventLog":62,"./ducks/flows":63,"./ducks/ui/flow":67}],77:[function(require,module,exports){
'use strict';
